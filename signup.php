<!-- code with code but little change
 in database table sno is primary key and username must be unique
-->
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($password === $cpassword) {
        ...
        $rowcount=mysqli_num_rows($showresult);
        ...
        if ($rowcount > 0) {
            ...
            if ($result) {
                $showAlert = true;
                // $showAlert = 'Your account is created & You can Log in Now .';
        ...
        <div class="container my-5 d-flex justify-content-center align-items-center">
            ...
            <form action="/LOGINSYSTEM/signup.php" method="POST">
                ...
                <div class="mb-3 col-md-15">
                    ...
                    <input type="password" minlength="3" class="form-control border-dark" id="password" name="password" required>
                </div>
                <div class="mb-3 col-md-15">
                    <label for="cpassword" class="form-label ">Confirn Password</label>
                    <input type="password" class="form-control border-dark" id="cpassword" name="cpassword" required>
